...
{
    public const string GENERATED_BY_DEFAULT_AS_IDENTITY = 'GENERATED BY DEFAULT AS IDENTITY';
    ...
    {
        if (in_array(static::GENERATED_BY_DEFAULT_AS_IDENTITY, $column->options)) {
            $column->type .= sprintf(' %s', static::GENERATED_BY_DEFAULT_AS_IDENTITY);
        }
