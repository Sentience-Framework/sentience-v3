...
class CreateTableQuery extends Query
{
    ...
    public function column(string $name, string $type, bool $notNull = false, mixed $defaultValue = null, array $options = []): static
    {
        $this->columns[] = new Column($name, $type, $notNull, $defaultValue, $options);
