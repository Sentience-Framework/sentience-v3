...
class AlterTableQuery extends Query
{
    ...
    public function addColumn(string $name, string $type, bool $notNull = false, mixed $defaultValue = null, array $options = []): static
    {
        $this->alters[] = new AddColumn($name, $type, $notNull, $defaultValue, $options);
